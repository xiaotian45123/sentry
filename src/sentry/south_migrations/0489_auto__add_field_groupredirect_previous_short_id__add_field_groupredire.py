...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'GroupRedirect.previous_short_id'
        db.add_column('sentry_groupredirect', 'previous_short_id',
                      self.gf('sentry.db.models.fields.bounded.BoundedBigIntegerField')(null=True),
                      keep_default=False)

        # Adding field 'GroupRedirect.previous_project_slug'
        db.add_column('sentry_groupredirect', 'previous_project_slug',
                      self.gf('django.db.models.fields.SlugField')(max_length=50, null=True),
                      keep_default=False)

        db.commit_transaction()
        db.execute(
            "CREATE INDEX CONCURRENTLY {} ON sentry_groupredirect (previous_short_id, previous_project_slug)".
            format(
    ...
    def backwards(self, orm):
        ...
        # ['previous_short_id', 'previous_project_slug']
        db.delete_unique('sentry_groupredirect', ['previous_short_id', 'previous_project_slug'])

        # Deleting field 'GroupRedirect.previous_short_id'
        db.delete_column('sentry_groupredirect', 'previous_short_id')

        # Deleting field 'GroupRedirect.previous_project_slug'
        db.delete_column('sentry_groupredirect', 'previous_project_slug')
    ...
    models = {
        ...
        'sentry.apiapplication': {
            ...
            'client_id': ('django.db.models.fields.CharField', [], {'default': "'260adf89dd574b50bf3f751b1f3291e0b8f1888fbee24fa69eaceb9147880a7a'", 'unique': 'True', 'max_length': '64'}),
            'client_secret': ('sentry.db.models.fields.encrypted.EncryptedTextField', [], {'default': "'acf977b0947d498a9343d4d16e95331d97f7f438814a4b2595167dff7e914da1'"}),
            'date_added': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now'}),
            'homepage_url': ('django.db.models.fields.URLField', [], {'max_length': '200', 'null': 'True'}),
            'id': ('sentry.db.models.fields.bounded.BoundedBigAutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'default': "'United Baboon'", 'max_length': '64', 'blank': 'True'}),
        ...
        'sentry.apigrant': {
            ...
            'code': ('django.db.models.fields.CharField', [], {'default': "'b2bd456e60c0481ba6d866b0b20e3c60'", 'max_length': '64', 'db_index': 'True'}),
            'expires_at': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2019, 6, 21, 0, 0)', 'db_index': 'True'}),
            'id': ('sentry.db.models.fields.bounded.BoundedBigAutoField', [], {'primary_key': 'True'}),
        ...
        'sentry.apitoken': {
            ...
            'application': ('sentry.db.models.fields.foreignkey.FlexibleForeignKey', [], {'to': "orm['sentry.ApiApplication']", 'null': 'True'}),
            'date_added': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now'}),
            'expires_at': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2019, 7, 21, 0, 0)', 'null': 'True'}),
            'id': ('sentry.db.models.fields.bounded.BoundedBigAutoField', [], {'primary_key': 'True'}),
            'refresh_token': ('django.db.models.fields.CharField', [], {'default': "'24073b635c41430887216d18f3cbe44feb881eeebf854030a430cfa29a1980b3'", 'max_length': '64', 'unique': 'True', 'null': 'True'}),
            'scope_list': ('sentry.db.models.fields.array.ArrayField', [], {'of': (u'django.db.models.fields.TextField', [], {})}),
            'scopes': ('django.db.models.fields.BigIntegerField', [], {'default': 'None'}),
            'token': ('django.db.models.fields.CharField', [], {'default': "'62d2362ff83f412f8769baf3addfef3f5b294fd99c574bc8ad2f80071935be2a'", 'unique': 'True', 'max_length': '64'}),
            'user': ('sentry.db.models.fields.foreignkey.FlexibleForeignKey', [], {'to': "orm['sentry.User']"})
        },
        ...
        'sentry.broadcast': {
            ...
            'date_added': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now'}),
            'date_expires': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2019, 6, 28, 0, 0)', 'null': 'True', 'blank': 'True'}),
            'id': ('sentry.db.models.fields.bounded.BoundedBigAutoField', [], {'primary_key': 'True'}),
        ...
        'sentry.groupshare': {
            ...
            'project': ('sentry.db.models.fields.foreignkey.FlexibleForeignKey', [], {'to': "orm['sentry.Project']"}),
            'user': ('sentry.db.models.fields.foreignkey.FlexibleForeignKey', [], {'to': "orm['sentry.User']", 'null': 'True'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'0c399a1d1a6a4d5abc6e02d13ad63728'", 'unique': 'True', 'max_length': '32'})
        },
        'sentry.groupsnooze': {
        ...
        'sentry.scheduleddeletion': {
            ...
            'data': ('sentry.db.models.fields.jsonfield.JSONField', [], {'default': '{}'}),
            'date_added': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now'}),
            'date_scheduled': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2019, 7, 21, 0, 0)'}),
            'guid': ('django.db.models.fields.CharField', [], {'default': "'7ac6c9feb4fd40a29f5cce6c4a8fb4fd'", 'unique': 'True', 'max_length': '32'}),
            'id': ('sentry.db.models.fields.bounded.BoundedBigAutoField', [], {'primary_key': 'True'}),
        ...
        'sentry.sentryapp': {
            ...
            'status': ('sentry.db.models.fields.bounded.BoundedPositiveIntegerField', [], {'default': '0', 'db_index': 'True'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'d6cb7915-a813-48ac-9dac-79b1838a9009'", 'max_length': '64'}),
        ...
        'sentry.sentryappinstallation': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'48df740b-71ac-49ee-b5c6-dfa513062c17'", 'max_length': '64'})
        },
        'sentry.servicehook': {
            ...
            'project_id': ('sentry.db.models.fields.bounded.BoundedPositiveIntegerField', [], {'db_index': 'True'}),
            'secret': ('sentry.db.models.fields.encrypted.EncryptedTextField', [], {'default': "'554152a9913b4fbcaed7cfbb19f9bd8d0f2ea70655a34fffb3328841d3767731'"}),
            'status': ('sentry.db.models.fields.bounded.BoundedPositiveIntegerField', [], {'default': '0', 'db_index': 'True'}),
        ...
        'sentry.useremail': {
            ...
            'validation_hash': ('django.db.models.fields.CharField', [], {'default': "u'kwI194US25vdxedRwaOCJq3xmyfzuAOw'", 'max_length': '32'})
        },
        'sentry.userip': {
